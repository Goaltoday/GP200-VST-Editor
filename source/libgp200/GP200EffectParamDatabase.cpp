...
// Generated from gp200editor-master/src/core/effectParams.ts.
// These entries affect display only; MIDI and preset values stay numeric.
constexpr DiscreteOptionEntry discreteOptionEntries[] = {
    {0x00000019u, 3, 0, "OFF"},
    {0x00000019u, 3, 1, "ON"},
    {0x0000001Au, 1, 0, "OFF"},
    {0x0000001Au, 1, 1, "ON"},
    {0x0000001Au, 2, 0, "OFF"},
    {0x0000001Au, 2, 1, "ON"},
    {0x01000001u, 3, 0, "Standard"},
    {0x01000001u, 3, 1, "Jumbo"},
    {0x01000001u, 3, 2, "Enhanced"},
    {0x01000001u, 3, 3, "Piezo"},
    {0x0100000Fu, 4, 0, "Guitar"},
    {0x0100000Fu, 4, 1, "Bass"},
    {0x01000015u, 6, 0, "OFF"},
    {0x01000015u, 6, 1, "ON"},
    {0x01000019u, 5, 0, "OFF"},
    {0x01000019u, 5, 1, "ON"},
    {0x01000049u, 0, 0, "-2 Oct"},
    {0x01000049u, 0, 1, "-1 Oct"},
    {0x01000049u, 0, 2, "+1 Oct"},
    {0x01000049u, 0, 3, "+2 Oct"},
    {0x01000049u, 0, 4, "+/-1 Oct"},
    {0x01000049u, 0, 5, "+/-2 Oct"},
    {0x01000049u, 1, 0, "OFF"},
    {0x01000049u, 1, 1, "ON"},
    {0x0100004Du, 1, 0, "C"},
    {0x0100004Du, 1, 1, "C#"},
    ...
    {0x0100004Du, 1, 10, "A#"},
    {0x0100004Du, 1, 11, "B"},
    {0x0100004Du, 2, 0, "Major"},
    {0x0100004Du, 2, 1, "Minor"},
    {0x0100004Du, 2, 2, "H. Minor"},
    {0x0100004Du, 2, 3, "Dorian"},
    {0x0100004Du, 2, 4, "Phrygian"},
    {0x0100004Du, 2, 5, "Lydian"},
    {0x0100004Du, 2, 6, "Mixolydian"},
    {0x0100004Du, 2, 7, "Locrian"},
    {0x0100004Du, 3, 0, "-Oct"},
    {0x0100004Du, 3, 1, "-7th"},
    {0x0100004Du, 3, 2, "-6th"},
    {0x0100004Du, 3, 3, "-5th"},
    ...
    {0x0100004Du, 3, 8, "+3rd"},
    {0x0100004Du, 3, 9, "+4th"},
    {0x0100004Du, 3, 10, "+5th"},
    {0x0100004Du, 3, 11, "+6th"},
    {0x0100004Du, 3, 12, "+7th"},
    {0x0100004Du, 3, 13, "+Oct"},
    {0x0100004Du, 4, 0, "OFF"},
    {0x0100004Du, 4, 1, "ON"},
    {0x0100004Eu, 1, 0, "C"},
    {0x0100004Eu, 1, 1, "C#"},
    ...
    {0x0100004Eu, 1, 10, "A#"},
    {0x0100004Eu, 1, 11, "B"},
    {0x0100004Eu, 2, 0, "Major"},
    {0x0100004Eu, 2, 1, "Minor"},
    {0x0100004Eu, 2, 2, "H. Minor"},
    {0x0100004Eu, 2, 3, "Dorian"},
    {0x0100004Eu, 2, 4, "Phrygian"},
    {0x0100004Eu, 2, 5, "Lydian"},
    {0x0100004Eu, 2, 6, "Mixolydian"},
    {0x0100004Eu, 2, 7, "Locrian"},
    {0x0100004Eu, 3, 0, "-Oct"},
    {0x0100004Eu, 3, 1, "-7th"},
    {0x0100004Eu, 3, 2, "-6th"},
    {0x0100004Eu, 3, 3, "-5th"},
    ...
    {0x0100004Eu, 3, 8, "+3rd"},
    {0x0100004Eu, 3, 9, "+4th"},
    {0x0100004Eu, 3, 10, "+5th"},
    {0x0100004Eu, 3, 11, "+6th"},
    {0x0100004Eu, 3, 12, "+7th"},
    {0x0100004Eu, 3, 13, "+Oct"},
    {0x0100004Eu, 4, 0, "-Oct"},
    {0x0100004Eu, 4, 1, "-7th"},
    {0x0100004Eu, 4, 2, "-6th"},
    {0x0100004Eu, 4, 3, "-5th"},
    ...
    {0x0100004Eu, 4, 8, "+3rd"},
    {0x0100004Eu, 4, 9, "+4th"},
    {0x0100004Eu, 4, 10, "+5th"},
    {0x0100004Eu, 4, 11, "+6th"},
    {0x0100004Eu, 4, 12, "+7th"},
    {0x0100004Eu, 4, 13, "+Oct"},
    {0x0100004Eu, 5, 0, "OFF"},
    {0x0100004Eu, 5, 1, "ON"},
    {0x03000008u, 3, 0, "OFF"},
    {0x03000008u, 3, 1, "ON"},
    ...
    {0x03000032u, 3, 1, "II"},
    {0x03000032u, 3, 2, "III"},
    {0x0300003Fu, 3, 0, "Normal"},
    {0x0300003Fu, 3, 1, "Scoop"},
    {0x0300003Fu, 3, 2, "Edge"},
    {0x03000044u, 7, 0, "Cut"},
    {0x03000044u, 7, 1, "Boost"},
    {0x03000044u, 7, 2, "Flat"},
    {0x03000050u, 3, 0, "Clean"},
    {0x03000050u, 3, 1, "OD"},
    {0x03000050u, 3, 2, "Dist"},
    {0x03000051u, 6, 0, "OFF"},
    {0x03000051u, 6, 1, "ON"},
    {0x04000000u, 3, 0, "OFF"},
    {0x04000000u, 3, 1, "ON"},
    ...
    {0x0400001Au, 2, 0, "OFF"},
    {0x0400001Au, 2, 1, "ON"},
    {0x0400001Bu, 0, 0, "Warm"},
    {0x0400001Bu, 0, 1, "Sharp"},
    {0x0400001Bu, 2, 0, "OFF"},
    {0x0400001Bu, 2, 1, "ON"},
    {0x0400001Eu, 4, 0, "OFF"},
    {0x0400001Eu, 4, 1, "ON"},
    ...
    {0x0700001Au, 5, 0, "OFF"},
    {0x0700001Au, 5, 1, "ON"},
    {0x07000027u, 5, 0, "Cool"},
    {0x07000027u, 5, 1, "Hot"},
    {0x07000073u, 3, 0, "220Hz"},
    {0x07000073u, 3, 1, "450Hz"},
    {0x07000073u, 3, 2, "800Hz"},
    {0x07000073u, 3, 3, "1.6kHz"},
    {0x07000073u, 3, 4, "3kHz"},
    {0x08000076u, 1, 0, "OFF"},
    {0x08000076u, 1, 1, "ON"},
    {0x0B000000u, 3, 0, "OFF"},
    {0x0B000000u, 3, 1, "ON"},
    ...
    {0x0B00001Fu, 7, 0, "OFF"},
    {0x0B00001Fu, 7, 1, "ON"},
    {0x0B000021u, 6, 0, "Past"},
    {0x0B000021u, 6, 1, "Present"},
    {0x0B000021u, 6, 2, "Future"},
    {0x0B000021u, 10, 0, "OFF"},
    {0x0B000021u, 10, 1, "ON"},
    {0x0B000021u, 11, 0, "OFF"},
    {0x0B000021u, 11, 1, "ON"},
    {0x0B000026u, 5, 0, "OFF"},
    {0x0B000026u, 5, 1, "ON"},
    {0x0B000026u, 6, 0, "OFF"},
    ...
    {0x0B000033u, 5, 10, "-2"},
    {0x0B000033u, 5, 11, "-1"},
    {0x0B000033u, 5, 12, "-50 cents"},
    {0x0B000033u, 5, 13, "-20 cents"},
    {0x0B000033u, 5, 14, "0"},
    {0x0B000033u, 5, 15, "+20 cents"},
    {0x0B000033u, 5, 16, "+50 cents"},
    {0x0B000033u, 5, 17, "1"},
    {0x0B000033u, 5, 18, "2"},
    {0x0B000033u, 5, 19, "3"},
    {0x0B000033u, 5, 20, "4"},
    ...
    {0x0B000033u, 5, 26, "10"},
    {0x0B000033u, 5, 27, "11"},
    {0x0B000033u, 5, 28, "+Oct"},
    {0x0B000033u, 6, 0, "Short"},
    {0x0B000033u, 6, 1, "Medium"},
    {0x0B000033u, 6, 2, "Long"},
    {0x0B000033u, 11, 0, "OFF"},
    {0x0B000033u, 11, 1, "ON"},
    {0x0B000033u, 12, 0, "OFF"},
    {0x0B000033u, 12, 1, "ON"},
    {0x0C000000u, 3, 0, "OFF"},
    {0x0C000000u, 3, 1, "ON"},
    {0x0C000001u, 3, 0, "OFF"},
                                                    ...
                                                    int value)
{
    for (const auto& entry : discreteOptionEntries)
        if (entry.effectId == effectId && entry.paramIndex == paramIndex && entry.value == value)
            return &entry;
...
float GP200EffectParamDatabase::getDiscreteOptionMinimum (juce::uint32 effectId, int paramIndex)
{
    ...
    for (const auto& entry : discreteOptionEntries)
    {
        ...
        result = found ? juce::jmin (result, entry.value) : entry.value;
        found = true;
    }
...
float GP200EffectParamDatabase::getDiscreteOptionMaximum (juce::uint32 effectId, int paramIndex)
{
    ...
    for (const auto& entry : discreteOptionEntries)
    {
        ...
        result = found ? juce::jmax (result, entry.value) : entry.value;
        found = true;
    }
...
juce::String GP200EffectParamDatabase::getDiscreteOptionLabel (juce::uint32 effectId,
                                                               int paramIndex,
                                                               float value)
{
    ...
    return juce::String (integerValue);
}
